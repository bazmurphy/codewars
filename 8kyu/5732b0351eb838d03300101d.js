...
function blackAndWhite(arr){
    let result = !Array.isArray(arr) ? "fake" : (arr.indexOf(5) >= 0 && arr.indexOf(13) >= 0) ? "black" : "white";
...
// Solution 7
const blackAndWhite = xs => `It's a ${Array.isArray(xs) ? xs.indexOf(5) > -1 && xs.indexOf(13) > -1 ? 'black' : 'white' : 'fake'} array`