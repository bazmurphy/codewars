...
const configuration = {
  ...
  "version": "0.1.0",
  "private": true,
  "homepage": "https://andorey.github.io/fuck_off/",
  "dependencies": {
    "react": "^16.12.0",
    "react-dom": "^16.12.0",
    "react-scripts": "3.2.0"
...
// Solution 9
const configuration = {
  "name": "quick-dirty-hack-1.0.0",
  "version": "1.0.0",
  "description": "quick dirty hack; do not user this package.",
  "keywords": ["hack"],
  "license": "UNLICENSED",
  "author": "falsetru",
  "contributors": [],
  "repository": { "type": "git", "url": "https://github.com/no-such-user/no-such-project" },
};
...
const configuration = {
  ...
  "version": "0.0.1",
  "keywords": ["keywords"],
  "bugs": "https://www.codewars.com",
  "license": "UNLICENSED",
  "author": "author",
  "contributors": [],
  "repository": { type: "public", url: "https://www.codewars.com" }
};