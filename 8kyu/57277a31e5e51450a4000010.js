...
function firstToLast(str,c){
  // if (str.indexOf(c) > - 1 && str.lastIndexOf(c) > -1) {
  //   return str.lastIndexOf(c) - str.indexOf(c);
  // } else {
  //   return -1;
  // }
  return str.indexOf(c) > - 1 && str.lastIndexOf(c) > -1 ? str.lastIndexOf(c) - str.indexOf(c) : -1;
}
...
// Solution 10
const firstToLast = (s, c) => s.indexOf(c) > -1 ? s.lastIndexOf(c) - s.indexOf(c) : -1 ;


// Solution 11
firstToLast = (str, c) => str.lastIndexOf(c) - Math.max(str.indexOf(c), 0)


// Solution 12
function firstToLast(str,c){
  return ~str.indexOf(c) ? str.lastIndexOf(c)-str.indexOf(c) : -1
}
