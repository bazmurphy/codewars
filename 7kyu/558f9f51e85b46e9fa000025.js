...
function differenceOfSquares(n) {
  let squareOfTheSumOfTheNumbers = 0;
  let sumOftheSquaresOfTheNumbers = 0;

  for (let i = 1; i <= n; i++) {
    squareOfTheSumOfTheNumbers += i;
    sumOftheSquaresOfTheNumbers += i * i;
  }
  squareOfTheSumOfTheNumbers = squareOfTheSumOfTheNumbers * squareOfTheSumOfTheNumbers;

  return squareOfTheSumOfTheNumbers - sumOftheSquaresOfTheNumbers;
}
